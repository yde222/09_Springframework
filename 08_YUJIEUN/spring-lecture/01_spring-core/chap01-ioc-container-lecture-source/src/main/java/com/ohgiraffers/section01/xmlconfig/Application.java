...
public class Application {
    ...
    public static void main(String[] args) {
        ApplicationContext applicationContext = new ClassPathXmlApplicationContext("section01/xmlconfig/spring-context.xml");
...
//        MemberDTO member = (MemberDTO) applicationContext.getBean("member");
        /* 2. bean클래스 메타 정보를 전달하여 가져오는 방법*/
//        MemberDTO member = applicationContext.getBean( MemberDTO.class);
        /* 3. bean 의 id와 클래스 메타정보를 전달하여 가져오는 방법*/
