package com.ohgiraffers.chap07listennerlecturesource.section01.contextlistner;
...
public class ContextListenerTest implements ServletContextListener, ServletContextAttributeListener {
    ...
    public ContextListenerTest() {
        ...
        System.out.println("context lstener 인스턴스 생성");
    }
    ...
    public void contextInitialized(ServletContextEvent sce) {
        /* context가 최초 생성될 때 생성자 호출 이후에도 동작하는 메소드 */
