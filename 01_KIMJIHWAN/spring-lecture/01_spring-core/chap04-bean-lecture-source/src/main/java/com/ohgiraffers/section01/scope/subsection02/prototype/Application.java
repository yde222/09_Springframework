...
import com.ohgiraffers.section01.scope.subsction01.singleton.ContextConfiguration;
...
public class Application {
    public static void main(String[] args) {
        ...
        System.out.println("쇼핑 카트 객체 꺼내기 다음");
        shoppingCart.addItem(carpBread);
        shoppingCart.addItem(milk);
        System.out.println("cart2에 담긴 물품 : " + shoppingCart.getItems());

        // 다음 손님 등장
        ShoppingCart shoppingCart2 = context.getBean("shoppingCart2", ShoppingCart.class);
        shoppingCart2.addItem(water);
        System.out.println("shoppingCart2에 담긴 물품 : = " + shoppingCart2.getItems());
    }
}
