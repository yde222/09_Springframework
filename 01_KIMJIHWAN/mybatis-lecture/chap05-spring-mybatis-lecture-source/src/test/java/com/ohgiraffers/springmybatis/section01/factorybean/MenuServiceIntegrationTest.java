...
/* 통합 테스트
* 실제 스프링 컨텍스트를 로딩하여 MenuService의 전체 동작(실제 DB와 연동 및 비지니스 로직 적용)
* 을 검증하는 테스트
* */
...
public class MenuServiceIntegrationTest {
    ...
    @Test
    public void testFindAllMenuByOrderalberStatus_Orderable(){

        //given
        String orderableStatus = "Y";

        // when
        List<MenuDTO> resultList = menuService.findAllMenuByOrderStatus(orderableStatus);
