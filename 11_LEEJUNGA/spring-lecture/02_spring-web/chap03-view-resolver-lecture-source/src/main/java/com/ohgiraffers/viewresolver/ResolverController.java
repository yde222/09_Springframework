...
public class ResolverController {
    ...
    public String stringRedirect() {
        ...
        // 그때는 viewresolver객채에게 redirect: 를 붙여서 요청하면
        // redirect 방식으로 이동
    ...
    public String stringRedirectAttr(RedirectAttributes rttr) {
        rttr.addAttribute("flashMessage", "리다이렉트 attr 사용하여 redirect");
    ...
    public ModelAndView modelAndViewRedirect(ModelAndView mv, RedirectAttributes rttr) {
        rttr.addFlashAttribute("flashMessage", "리다이렉트를 attr 사용하여 redirect");
