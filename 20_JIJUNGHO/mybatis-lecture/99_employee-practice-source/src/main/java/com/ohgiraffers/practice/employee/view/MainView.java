...
public class MainView {
        ...
        while(true) {
            ...
            switch (no) {
                case 1:
                    ...
                    break;
                case 2:
                    employeeController.selectMemberByMemberCode(inputMemberCode());
                    break;
                case 3:
                    employeeController.registMember(inputMember());
                    break;
                case 4:
    ...
    private static Map<String, String> inputMember() {
        ...
        parameter.put("empName", memberName);
        parameter.put("email", memberEmail);
