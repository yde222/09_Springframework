...
public class ContextListenerTest implements ServletContextListener , ServletContextAttributeListener {
    ...
    public ContextListenerTest() {
        /* context가 생설될때 변화를 감지하는 Listener 인스턴스가 함께 생성됨 */
        System.out.println("context listener 인스턴스 생성됨");
    }

    @Override
    public void attributeAdded(ServletContextAttributeEvent event) {
        // context에 attribute가 추가될때 동작
        System.out.println("context attribute added!!!!");
    }

    @Override
    public void attributeRemoved(ServletContextAttributeEvent event) {
        // context에 attribute가 삭제될때 동작
        System.out.println("context attribute removed!!!!");
    }

    @Override
    public void attributeReplaced(ServletContextAttributeEvent event) {
        // context에 attribute가 변경될때 동작
        System.out.println("context attribute replaced!!!!");
    }

    @Override
    public void contextInitialized(ServletContextEvent sce) {
        // context가 최초 생성될때 생성자 호출 이후에 동작하는 메소드
