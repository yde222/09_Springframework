package com.jjh.chap09eljstllecturesource.el.controller;

import com.jjh.chap09eljstllecturesource.el.model.dto.MemberDTO;
...
public class TestFourServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        MemberDTO requestMember = new MemberDTO("지정호", 30, "010-5501-7918", "kiik52@naver.com");
