...
// Aspect(분리된 횡단 관심사) ㅣ point-cut(삽입 시점) + Advice(부가 코드)
@Component
@Aspect
public class LoggingAspect {
    ...
    public void logBefore(JoinPoint joinPoint) {
        // Joinpoint : 포인트 컷으로 패치한 실행 시점으로 메소드명, 인수값 등이 정보에 접근 가능
        System.out.println("before joinporint.getTarget() = " + joinPoint.getTarget());
