...
<h1>라이프 사이클 테스트</h1>
<br/>
<a href="xml-lifecycle">XML설정</a>
<a href="annotation-lifecycle">Annotation 설정</a>

<h2>Service 메소드의 역할</h2>
<h3>a 태그의 href 속성값 요청</h3>
<a href="request-service">서비스 메소드 요청</a> <%--주소 요청은 GET--%>
<h3>form 태그의 method속성을 get으로 설정해서 요청</h3>
<form action="request-service" method="get">
  <input type="submit" value="get 방식의 요청">
</form>
<h3>form 태그의 method속성을 post로 설정해서 요청</h3>
