...
public class ContextListenerTest implements ServletContextListener, ServletContextAttributeListener {
    ...
    public ContextListenerTest() {
        ...
        System.out.println("ContextListener 인스턴스가 생성되.");
    }

    @Override
    public void attributeAdded(ServletContextAttributeEvent event) {
        /* context에 attribute가 추가될 때 동작 */
        System.out.println("context attribute 추가가 되.");
    }

    @Override
    public void attributeRemoved(ServletContextAttributeEvent event) {
        /* context에 attribute가 제거될 때 동작 */
        System.out.println("context attribute 삭제가 되.");
    }

    @Override
    public void attributeReplaced(ServletContextAttributeEvent event) {
        /* context에 attribute가 변경될 때 동작 */
        System.out.println("context attribute 변경이 되.");
    }

    @Override
    public void contextInitialized(ServletContextEvent sce) {
        /* context가 최초 생성될 때 생성자 호출 이후에 동작하는 메소드*/
        System.out.println("context가 생성이 되.");
    }

    @Override
    public void contextDestroyed(ServletContextEvent sce) {
        /* context가 소멸할 때 동작하는 메소드 */
        System.out.println("context가 종료가 되.");
    }
}
