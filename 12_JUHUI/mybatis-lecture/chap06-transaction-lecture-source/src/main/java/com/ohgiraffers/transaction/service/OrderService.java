...
public class OrderService {
    ...
    public OrderService(OrderMapper orderMapper) { // 의존성 주입
        this.orderMapper = orderMapper;
    }

    /* 주문 등록 기능 메소드
    * Controller 에서 넘어온 DTO 를 도메인 모델로 변환 후
    ...
    * */
    ...
    public void registerOrder(OrderDTO orderDTO, List<OrderMenuDTO> orderMenuDTOs) {
        ...
        List<OrderMenu> orderMenus = orderMenuDTOs.stream().map(dto -> {
            ...
            // 주문 등록 후 auto generated 된 orderCode 를 각 주문 메뉴에 설정
            orderMenu.setOrderCode(dto.getOrderCode());
            return orderMenu;
