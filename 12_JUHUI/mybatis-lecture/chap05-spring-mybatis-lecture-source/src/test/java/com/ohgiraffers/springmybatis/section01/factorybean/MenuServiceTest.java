...
class MenuServiceTest {
    ...
    @Mock
    private MenuMapper menuMapper; // Mybatis Mapper 구현체(인터페이스) 없이 메소드 호출 가능
    ...
    public void testFindAllMenuByOrderableStatus_Orderable(){
        ...
        // 모의 객체 MenuMapper가 findAllMenuByOrderableStatus 기능 호출 시 originList 를 반환하도록 설정
        when(menuMapper.findAllMenuByOrderableStatus(orderable)).thenReturn(originList);
