...
class ProblemsOfUsingDirectSQLTests {
    ...
    * */
    ...
    void testDirectSelectSQL() throws SQLException {
        ...
        while(reset.next()) {
            Menu menu = new Menu();
            menu.setMenuCode(reset.getInt("menu_code"));
            menu.setMenuName(reset.getString("menu_name"));
            menu.setMenuPrice(reset.getInt("menu_price"));
            menu.setCategoryCode(reset.getInt("category_code"));
            menu.setOrderableStatus(reset.getString("orderable_status"));
    ...
    void testChangeSelectColumSEL() throws SQLException {
