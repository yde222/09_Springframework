package com.ohgriaffers.section03.properties.subsection01.properties;
...
import com.ohgriaffers.section02.subsection02.annotation.Owner;
...
public class ContextConfiguration {
    ...
    @Value("${bread.carpbread.price:0}")//${}는 el태그랑 비슷
    private int price;
