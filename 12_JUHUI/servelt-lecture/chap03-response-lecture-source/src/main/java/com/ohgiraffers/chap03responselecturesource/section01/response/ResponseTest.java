...
//        System.out.println("응답 확인");
        ...
        response.setContentType("text/html;charset=utf-8"); // 위의 두 가지 설정을 한 번에 가능함.

        /* tomcat 10버전 이상부터는 MIME type만 기재해도 문자 셋이 자동으로 utf-8 설정 */
        response.setContentType("text/plain");

        // 사용자 브라우저에 응답하기 위한 출력 스트림을 response 에서 반환 받는다.
