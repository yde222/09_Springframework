package com.ohgiraffers.secion01.scope.subsection01.singleton;
...
public class ContextConfiguration {
    ...
    @Bean
//    @Lazy             // 컨테이너가 동작 시점이 아니라 해당 객체 필요 시점에 인스턴스를 생성한다.
    @DependsOn({"crapsBread", "milk", "waters"})    // 나열한 빈 인스턴스가 모두 생성된 뒤 생성되도록
    @Scope("singleton") // 기본값
