...
public class FileUploadController {
    ...
    public String singleFileUpload(
        ...
        System.out.println("originalFileName of singleFile = " + singleFile.getOriginalFilename());
        String savedFileName = generateSavedFileName(singleFile);
    ...
    public String multiFileUpload(
        ...
        try {
            for(MultipartFile multiFile : multiFiles) {
                ...
                String savedFileName = generateSavedFileName(multiFile);
                ...
                // DB에서 관리할 파일 정보 추가
                files.add(new FileDTO(originalFileName, savedFileName, filePath, multiFileDescription));
            }
            ...
            for (FileDTO fileDTO : files) {
                new File(filePath + "/" + fileDTO.getOriginalFileName()).delete();
            }
