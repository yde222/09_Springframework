...
/* 단위테스트
* Mockito를 활용하여 의존성을 모킹(Mocking)한 후 MenuService의 순수 비즈니스 로직을 검증
*  */
...
class MenuServiceTest {
    ...
    public void setUp() {
        // when은 Mockito에서 제공
        // sqlSession.getMapper(MenuMapper.class) 호출 시에 모의 객체 menuMapper를 반환하도록 설정3
