...
public class Application {
    ...
    public static void main(String[] args) {
        ...
        // 생성한 환경설정 정보로 Mybatis 설정 객체 생성 (org.apache. ...)
        ...
        SqlSessionFactory sqlSessionFactory = new SqlSessionFactoryBuilder().build(configuration);  // configuration이라는 도면을 바탕으로 공장을 만듦
