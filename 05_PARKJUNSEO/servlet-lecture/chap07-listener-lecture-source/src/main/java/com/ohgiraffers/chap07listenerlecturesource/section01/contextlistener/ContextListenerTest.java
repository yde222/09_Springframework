...
public class ContextListenerTest implements ServletContextListener, ServletContextAttributeListener {
     ...
     * 3-2. ServletRequestListenerServlet : ServletRequest에 attribute를 추가, 제거, 수정하는 것에 대한 이벤트 리스너
     * */
    ...
    public void attributeRemoved(ServletContextAttributeEvent event) {
        /* context에 attribute가 삭제, 제거될 때 동작 */
        System.out.println("context attribute removed!!");
    }

    @Override
    public void attributeReplaced(ServletContextAttributeEvent event) {
        /* context에 attribute가 수정, 변경될 때 동작 */
        System.out.println("context attribute replaced!!");
    }

    @Override
    public void contextInitialized(ServletContextEvent sce) {
        /* context가 최초 생성될 때 생성자 호출 이후에 작동하는 메소드 */
        System.out.println("context initialized!!");
    }

    @Override
    public void contextDestroyed(ServletContextEvent sce) {
        /* context가 소멸될 때 생성자 호출 이후에 작동하는 메소드 */
